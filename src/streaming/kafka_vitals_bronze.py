...
raw_df = (
    ...
    .option("subscribe", "clinical-vitals")
...
bronze_df = (
    ...
    .withColumn(
        "parsed",
        F.from_json("raw_payload", vitals_schema),
    )
    .select(
        "*",
        "parsed.*",
...
query = (
    ...
    .option(
        "checkpointLocation",
        "/Volumes/workspace/default/"
        "healthcare_lakehouse/checkpoints/kafka/vitals",
    )
    .trigger(availableNow=True)
    .toTable("workspace.default.bronze_kafka_vitals")
)
